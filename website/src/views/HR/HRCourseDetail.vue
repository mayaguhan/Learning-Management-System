<template>
    <div>
        ...
        <p>
            ...
            Enrolled Students: {{ courseDetail.enrollment_count }} / {{ courseDetail.capacity }}
            <br>
            <br>
            ...
            <br>
            <br>
            <router-link :to="{ name: 'EnrolStudent', params: { course_id: course_id, trainer_id: trainer_id } }">
                <v-btn class="primary">
                    Enrol Students
                </v-btn>
            </router-link>
